...
function openLeftMenu() {
    ...
    if (watchingChannelId){
        var activeChannel = document.querySelectorAll('._channels_group:not(.hidden) .ch-item[_id="' + watchingChannelId + '"]')[0];
    }
    else {
...
var AUTH_URL = 'https://cdnua02.hls.tv/v3/hlsclient/auth';
